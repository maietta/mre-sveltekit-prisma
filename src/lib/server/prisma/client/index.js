...
const config = {
  "generator": {
    ...
    "output": {
      "value": "/home/nick/Projects/mre-sveltekit-prisma/src/lib/server/prisma/client",
      "fromEnvVar": null
    },
    "config": {
      "engineType": "library"
    ...
    "previewFeatures": [],
    "sourceFilePath": "/home/nick/Projects/mre-sveltekit-prisma/prisma/schema.prisma",
    "isCustomOutput": true
  },
  "relativeEnvPaths": {
    "rootEnvPath": "../../../../../.env",
  ...
  "inlineSchemaHash": "8ffbc52701e78b549d732491994575082a62a5a305ce06ddcecb6f5a4bd6cbde",
  "copyEngine": true
}
...
path.join(process.cwd(), "src/lib/server/prisma/client/libquery_engine-rhel-openssl-3.0.x.so.node")

// file annotations for bundling tools to include these files
path.join(__dirname, "libquery_engine-debian-openssl-1.1.x.so.node");
path.join(process.cwd(), "src/lib/server/prisma/client/libquery_engine-debian-openssl-1.1.x.so.node")
// file annotations for bundling tools to include these files
path.join(__dirname, "schema.prisma");
path.join(process.cwd(), "src/lib/server/prisma/client/schema.prisma")
